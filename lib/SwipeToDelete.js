...
var SwipeToDelete = /*#__PURE__*/function (_React$Component) {
  ...
  function SwipeToDelete() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onMouseUp", function () {
      ...
      var notShowDelete = (rtl ? -1 : 1) * _this.state.translate >= acceptableMove; // const deleteWithoutConfirm = (rtl ? 1 : -1) * this.state.translate >= this.deleteWithoutConfirmThreshold;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onDeleteClick", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
      var _this$props2, transitionDuration, onDelete, confirmDelete;

      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this$props2 = _this.props, transitionDuration = _this$props2.transitionDuration, onDelete = _this$props2.onDelete, confirmDelete = _this$props2.confirmDelete;
              _context.next = 3;
